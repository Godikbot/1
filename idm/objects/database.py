...
class DB_defaults:
    ...
    responses: dict = {
        ...
        "user_ret_err_no_access": "Не могу добавить {ссылка}.<br>две причины:<br>1 он(а) запретил(а) себя добавлять в беседу.<br>2 он(а) находиться в беседе<br>совет дежурного, кикайте её/его чтобы добавить снова,",
        "user_ret_err_vk": "Не могу добавить {ссылка}.<br>Потомучто нет в друзьях.<br>",
        ...
        "repeat_if_forbidden": "Мне очень лень давай завтра.",
